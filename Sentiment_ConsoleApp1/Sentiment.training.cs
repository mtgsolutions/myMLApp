...
namespace Sentiment_ConsoleApp1
{
    public partial class Sentiment
    {
        public const string RetrainFilePath =  @"C:\Users\milto\source\repos\myMLApp\myMLApp\yelp_labelled.txt";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"col0",outputColumnName:@"col0")      
                                    ...
                                    .Append(mlContext.MulticlassClassification.Trainers.OneVersusAll(binaryEstimator:mlContext.BinaryClassification.Trainers.FastForest(new FastForestBinaryTrainer.Options(){NumberOfTrees=4,NumberOfLeaves=4,FeatureFraction=0.932359F,LabelColumnName=@"col1",FeatureColumnName=@"Features"}),labelColumnName:@"col1"))      
